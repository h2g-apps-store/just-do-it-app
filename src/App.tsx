      ...
      <div className="px-96 py-5 space-y-5 bg-gray-100 ">
        <form>
          <div className="flex gap-3">
            ...
            <button
              type="button"
              className="font-bold w-60 text-white p-0  flex items-center justify-center text-3xl bg-[#059669] hover:bg-[#1fb888] active:bg-[#059669] cursor-pointer  active:text-white"
            >
              +
            </button>
          </div>
